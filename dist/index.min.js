...
var newXMLHttpRequest = function newXMLHttpRequest(Request) {
  var _XMLHttpRequest = Request;
  return function () {
    var reversedInterceptors = interceptors$1.reduce(function (array, interceptor) {
      return [interceptor].concat(array);
    }, []);
    var xhr = new _XMLHttpRequest();
    reversedInterceptors.forEach(function (_ref) {
      var requestAbout = _ref.requestAbout,
          requestError = _ref.requestError,
          requestLoad = _ref.requestLoad,
          requestLoadStart = _ref.requestLoadStart,
          requestLoadEnd = _ref.requestLoadEnd,
          requestProgress = _ref.requestProgress,
          requestOnreadyStateChange = _ref.requestOnreadyStateChange,
...
var ajaxIntercept = function ajaxAttach(env) {
  env.XMLHttpRequest = newXMLHttpRequest(env.XMLHttpRequest);
  return {
    register: function register(interceptor) {
      interceptors$1.push(interceptor);
      return function () {
        var index = interceptors$1.indexOf(interceptor);
        if (index >= 0) {
          interceptors$1.splice(index, 1);
        }
      };
    },
...
var ajaxListener = ajaxIntercept(window);
ajaxListener.register({
  requestError: function requestError(xhr) {
    console.log(xhr, 111);
  },
  requestAbout: function requestAbout(xhr) {
    console.log(xhr, 222);
  },
  requestLoad: function requestLoad(xhr) {
    console.log(xhr, 333);
  }
});
